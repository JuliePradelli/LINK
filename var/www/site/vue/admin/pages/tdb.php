...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="vue/admin/vendor/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Tableau de bord Administrateur</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php?page=admin_utilisateurs"><i class="fa fa-bar-chart-o fa-fw"></i> Utilisateurs</a>
                        </li>
                        <li>
    ...
    <script src="vue/admin/vendor/bootstrap/js/bootstrap.min.js"></script>
