...
<html lang="en">
    ...
    <head>
        ...
        <title>LINK-Changement mot de passe</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>LINK</strong> Changement mot de passe</h1>
                            <div class="description">
                                <p>
                                        Changement mot de passe de votre compte personnel
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                                            <form role="form" action="index.php?page=mot_de_passe" method="post" class="login-form">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="password" name="oldmdp" placeholder="Ancien mot de passe..." class="form-password form-control" id="form-password">
                                                </div>
                                                <div class="form-group">
                                                        <label class="sr-only" for="form-password">Nouveau mot de passe</label>
                                                        <input type="password" name="newmdp" placeholder="Nouveau mot de passe..." class="form-password form-control" id="form-password">
                                                </div>
                                                <div class="form-group">
                                                        <label class="sr-only" for="form-password">Confirmation mot de passe</label>
                                                        <input type="password" name="confmdp" placeholder="Confirmation mot de passe..." class="form-password form-control" id="form-password">
                                                </div>
