                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>LINK</strong> Inscription</h1>
                            <div class="description">
                            	<p>
	                            	Si vous remplissez ce formulaire et le validez, votre requête sera traitée par un administrateur.
                            	</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Inscrivez-vous sur notre site</h3>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="index.php?page=user_inscription" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-password">Mot de passe</label>
                                        <input type="password" name="mdp_conf" placeholder="Confirmation mot de passe..." class="form-password form-control" id="form-password">
                                    </div>
                                    <div class="form-group">
